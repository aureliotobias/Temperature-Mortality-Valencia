...
### Carmen Iñiguez (carmen.iniguez@uv.es), Aurelio Tobias(aurelio.tobias@idaea.csic.es)                 ###
###                                                                                                     ### 
### valencia0107.R                                                                                      ###
...
cold
logRR   <- predcen$allfit[cold] 
logRRse <- predcen$allse[cold]  
cbind(exp(logRR), exp(logRR-1.96*logRRse), exp(logRR+1.96*logRRse))
...
heat
logRR   <- predcen$allfit[heat] 
logRRse <- predcen$allse[heat]  
cbind(exp(logRR), exp(logRR-1.96*logRRse), exp(logRR+1.96*logRRse))
